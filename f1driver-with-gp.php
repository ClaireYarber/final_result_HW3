...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertF1DriverGP($_POST['f1driver_id'], $_POST['gp_id'], $_POST['gp_name'], $_POST['rank_number'], $_POST['total_points'], $_POST['country'], $_POST['day_time'])) {
        echo '<div class="alert alert-success" role="alert">Grand Prix record added.</div>';
      } else {
        echo '<div class="alert alert-danger" role="alert">Error.</div>';
      }
      break;
    case "Edit":
      if (updateF1DriverGP($_POST['f1driver_id'], $_POST['gp_id'], $_POST['gp_name'], $_POST['rank_number'], $_POST['total_points'], $_POST['country'], $_POST['day_time'], $_POST['rank_id'])) {
        echo '<div class="alert alert-success" role="alert">Grand Prix record updated.</div>';
      } else {
        echo '<div class="alert alert-danger" role="alert">Error.</div>';
      }
